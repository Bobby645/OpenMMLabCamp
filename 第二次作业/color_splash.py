...
score_thr = 0.8
video_reader = mmcv.VideoReader('/content/mmdetection/data/balloon/test_video.mp4')
fourcc = cv2.VideoWriter_fourcc(*'mp4v')
video_writer = cv2.VideoWriter(
    'color_splash_result.mp4', fourcc, video_reader.fps,
...
model = init_detector('/content/mmdetection/work_dirs/mask_rcnn_r50_fpn_2x_balloon/mask_rcnn_r50_fpn_2x_balloon.py', '/content/mmdetection/work_dirs/mask_rcnn_r50_fpn_2x_balloon/latest.pth',device=device)
