...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/content/mmdetection/data/balloon/annotations/train.json',
        img_prefix='/content/mmdetection/data/balloon/train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(type='Resize', img_scale=(1333, 800), keep_ratio=True),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/content/mmdetection/data/balloon/annotations/val.json',
        img_prefix='/content/mmdetection/data/balloon/val',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
